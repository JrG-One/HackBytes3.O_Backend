...
exports.getOverallComments = async (req, res) => {
  try {
    ...
    const systemPrompt = "Assume the role of a technical recruiter. Provide overall comments on the resume belowon two sections i.e Strengths and Improvements.";
    const userPrompt = `Resume content: ${resumeUrl}`;
...
exports.getImprovementTips = async (req, res) => {
  try {
    ...
    const systemPrompt = "Assume the role of a technical recruiter. Provide tips to improve the resume for the current technical job market.";
    const userPrompt = `Resume content: ${resumeUrl}`;
